...
import { markLiveAttended, markRecordingWatched } from '@/lib/bot/education/course-progress';
...
export async function POST(_request: Request, { params }: RouteParams) {
  ...
  try {
    await markRecordingWatched(auth.admin, auth.telegramId, { sanityLessonId });
